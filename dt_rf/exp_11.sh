...
for num_trees in 2 4 8 16 32 64 128; do
    numactl --physcpubind=0 --membind=0,1 -- python3 rf.py datasets_all/HIGGS.csv 1 5 0 0 $num_trees $train_size 0
    # Execute the first command
    numactl --physcpubind=0 --membind=0,1 -- gramine-sgx ./sklearnex ./rf.py datasets_all/HIGGS.csv 1 5 1 0 $num_trees $train_size 0
    # data.csv >> results/result_dt.csv
done

cp results/result_rf.csv ../final_results/rf/num_trees_no_bootstrap.csv
