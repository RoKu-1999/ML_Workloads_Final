...
for num_threads in 64 32 16 8 4 2 1; do
    ...
    numactl --physcpubind=$physcpubind --membind=0,1 -- gramine-sgx ./sklearnex ./rf.py datasets_all/HIGGS.csv 5 1 3 128 $num_threads $train_size 1
    ...
    numactl --physcpubind=$physcpubind --membind=0,1 -- python3 rf.py datasets_all/HIGGS.csv 5 0 3 128 $num_threads $train_size 1
    # If you want to output to a file, uncomment the next line
    # >> results/result_dt_python.csv
done

cp results/result_rf.csv ../final_results/rf/multithreads_bootstrap.csv
