...
for max_depth in 3 5 7 9 11 13 15 0; do
    ...
    sgx=1
    numactl --physcpubind=0 --membind=0,1 -- gramine-sgx ./sklearnex ./dt.py $dataset $iterations 1 $max_depth 70
    ...
    sgx=0
    numactl --physcpubind=0 --membind=0,1 -- ./../../perf_tool/bin/perf record -e cpu-clock:HGu -o perf.data python3 dt.py $dataset $iterations 0 $max_depth 70
