...
g.map_dataframe(sns.barplot, x="arch", y="epoch_train", hue="sgx")

# Add titles and labels
g.set_titles("Batch Size: {col_name}")
g.set_axis_labels("Architecture", "Average Training Time")
...
# Save the plot
plt.savefig("nn_training_batch_sizes.pdf", bbox_inches="tight")
