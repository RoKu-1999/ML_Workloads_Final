...
# Load your data
df = pd.read_csv('result_epoch_train.txt')

# Normalize the 'epoch_train' by dividing by 1e9 if necessary
df['epoch_train'] = df['epoch_train'] / 1e9
...
g.map_dataframe(sns.lineplot, x="threads", y="epoch_train", hue="arch")

# Add titles and labels
g.set_titles("Batch Size: {col_name}")
g.set_axis_labels("Number of Threads", "Average Training Time")
...
# Save the plot
plt.savefig("nn_training_numa.pdf", bbox_inches="tight")
