...
df = df.groupby(['function', 'sgx', 'num_trees'])['percent_spent'].sum().reset_index()
...
pivot_df = df.pivot_table(index='num_trees', columns=['sgx', 'function'], values='percent_spent', aggfunc='sum').fillna(0)
